...
namespace ExtensibleOpeningManager.Tools
{
    public static class CreationTools
    {
        ...
        public static FamilyInstance CreateFamilyInstance(SE_LinkedInstance instance, Document doc)
        {
            return CreateFamilyInstance(new PlaceParameters(instance, doc), doc, SymbolType.Square);
        }
